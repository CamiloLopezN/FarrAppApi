...
function sendEmailRegisterCompany(userMail, companyName) {
  ...
  <body>
      ...
      <div id="div2">
          <h3 id="m1">Solicitud de registro de empresa en FarrApp.<br>Bienvenido a FarrApp!</h3>
          <a id="title">${companyName}</a>
          <h3 id = "m1"> Se ha registrado un empresa con este correo.<br> Tu solicitud para unirte a FarrApp ha sido
              recibida.<br>
              Pronto un asesor se comunicará contigo para continuar con el proceso de registro.
          </h3>
...
function sendCreatedUserByAdmin(userMail, userName, generatedPassword) {
  ...
  <body>
      ...
      <div id="div2">
          <h3 id="m1">Solicitud de registro en FarrApp.<br>Hola. </h3>
          <a id="title">${userName}</a>
          <h3 id="m1">Te informamos que tu cuenta ha sido creada.<br> Puedes ingresar con los siguientes datos: <br>Correo
              electrónico: ${userMail} <br>Contraseña: ${generatedPassword}<br>Recuerda cambiar la contraseña en tu primer
              inicio de sesión.</h3>
          <h3 id="m2">Equipo de desarrollo de FarrApp</h3>
      </div>
